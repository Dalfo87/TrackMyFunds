...
export interface IRealizedProfit extends Document {
  ...
  originalTransactionId: string; // ID della transazione di vendita originale
...
export default mongoose.model<IRealizedProfit>('RealizedProfit', RealizedProfitSchema);